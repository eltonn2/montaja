...
CREATE TABLE IF NOT EXISTS montadores (
    ...
    assinatura_ativa_em DATETIME,
    trial_termina_em DATETIME,
    assinatura_fim DATETIME,
    ultimo_pagamento_mp TEXT,
...
INSERT INTO montadores (
    id, nome, verificado, avaliacao, total_avaliacoes, trabalhos_concluidos, tempo_resposta,
    dias_garantia, foto, whatsapp, cidade, bairros_atendimento, anos_experiencia, bio,
    fotos_portfolio, assinatura_status, assinatura_ativa_em, trial_termina_em, assinatura_fim
) VALUES
(1, 'Carlos Eduardo Silva', 1, 4.9, 156, 156, 'Responde em ~15 min', 30, 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=400&q=80', '11987654321', 'São Paulo', 'Moema, Pinheiros, Vila Mariana e Centro', 7, 'Especialista em montagem de guarda-roupas grandes e cozinhas planejadas. Atendimento rápido e limpo com ferramentas profissionais.', '["https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&w=300&q=80","https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=300&q=80","https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=300&q=80"]', 'active', datetime('now'), datetime('now', '+30 days'), datetime('now', '+30 days')),
(2, 'Marcelo Oliveira', 1, 4.8, 98, 98, 'Responde em ~30 min', 15, 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?auto=format&fit=crop&w=400&q=80', '11976543210', 'São Paulo', 'Tatuapé, Anália Franco, Mooca e Região Leste', 5, 'Pontualidade e cuidado com seu imóvel. Montagem de escritórios corporativos, home office e reparos em gavetas e portas.', '["https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=300&q=80","https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=300&q=80"]', 'active', datetime('now'), datetime('now', '+30 days'), datetime('now', '+30 days')),
(3, 'Roberto "Beto" Santos', 1, 5.0, 210, 210, 'Responde em ~15 min', 90, 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=400&q=80', '21998765432', 'Rio de Janeiro', 'Barra da Tijuca, Recreio, Copacabana e Botafogo', 10, 'Mais de 10 anos no ramo de montagens finas. Instalação perfeita de armários sob medida, nichos e suportes de TV na parede.', '["https://images.unsplash.com/photo-1507652313519-d4e9174996dd?auto=format&fit=crop&w=300&q=80","https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=300&q=80","https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&w=300&q=80"]', 'active', datetime('now'), datetime('now', '+30 days'), datetime('now', '+30 days')),
(4, 'Lucas Ferreira', 1, 4.7, 84, 84, 'Responde em ~1 hora', 30, 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=400&q=80', '11965432109', 'São Paulo', 'Santo Amaro, Morumbi, Campo Belo e Grajaú', 4, 'Montador rápido para móveis convencionais (Ikea, MadeiraMadeira, Tok&Stok). Orçamento justo e sem enrolação.', '["https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=300&q=80"]', 'active', datetime('now'), datetime('now', '+30 days'), datetime('now', '+30 days')),
(5, 'Juliana & André (Dupla)', 1, 4.9, 142, 142, 'Responde em ~15 min', 60, 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=400&q=80', '31988776655', 'Belo Horizonte', 'Savassi, Lourdes, Buritis e Anchieta', 6, 'Trabalho em dupla para montagens complexas e grandes volumes. Entregamos seu ambiente pronto na metade do tempo!', '["https://images.unsplash.com/photo-1507652313519-d4e9174996dd?auto=format&fit=crop&w=300&q=80","https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&w=300&q=80"]', 'active', datetime('now'), datetime('now', '+30 days'), datetime('now', '+30 days')),
(6, 'Fernando Souza', 1, 4.8, 115, 115, 'Responde em ~30 min', 30, 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?auto=format&fit=crop&w=400&q=80', '41999887766', 'Curitiba', 'Batel, Água Verde, Bigorrilho e Centro', 8, 'Especialista em desmontagem e remontagem para mudanças, além de regulagem de dobradiças e corrediças de gavetas.', '["https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&w=300&q=80","https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&w=300&q=80"]', 'active', datetime('now'), datetime('now', '+30 days'), datetime('now', '+30 days'));
